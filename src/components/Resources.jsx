  ...
  const resources = {
    videos: [
      {
        ...
        description:
          "Curso completo que cubre los fundamentos esenciales de JavaScript desde cero.",
      },
      {
        ...
        description:
          "Tutorial práctico sobre manipulación del DOM y manejo de eventos.",
      },
      {
        ...
        description:
          "Serie de videos sobre programación asíncrona en JavaScript.",
      },
    ],
    articles: [
      {
        ...
        description:
          "Guía completa y oficial de JavaScript con ejemplos prácticos.",
      },
      {
        ...
        description:
          "Serie de libros gratuitos que profundizan en los conceptos de JavaScript.",
      },
      {
        ...
        description:
          "Tutorial moderno de JavaScript con ejercicios interactivos.",
      },
    ],
    tools: [
      {
        ...
        description:
          "Editor de código gratuito con excelente soporte para JavaScript.",
        features: [
          "IntelliSense",
          "Debugging",
          "Extensions",
      ...
      },
      {
        ...
        description:
          "Plataforma online para escribir y probar código HTML, CSS y JavaScript.",
    ...
    interactive: [
      ...
      },
      {
        ...
        description:
          "Plataforma para practicar algoritmos y estructuras de datos.",
      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            Colección curada de recursos de alta calidad para complementar y
            enriquecer el proceso de aprendizaje de JavaScript.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-6 md:gap-8 min-w-0">
          {resources[activeCategory].map((resource, index) => (
            <div
              key={index}
              className="card-cola group hover:shadow-2xl transition-all duration-300 overflow-hidden min-w-0 max-w-full"
            >
              ...
              <div className="space-y-2 xs:space-y-3 overflow-hidden min-w-0">
                {resource.author && (
                  <div className="flex items-start space-x-2 min-w-0">
                    <span className="text-xs font-semibold text-cola-red flex-shrink-0">
                      Autor:
                    </span>
                    <span className="text-xs xs:text-sm text-gray-600 break-words min-w-0 leading-tight overflow-wrap-anywhere">
                      {resource.author}
                    </span>
                  </div>
                )}
                {resource.duration && (
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs xs:text-sm text-gray-600 flex-shrink-0">
                      {resource.duration}
                    </span>
                  </div>
                )}
                {resource.level && (
                  <div className="flex items-center space-x-2">
                    ...
                    <span
                      className={`text-xs xs:text-sm px-2 py-1 rounded-full flex-shrink-0 ${
                        resource.level === "Principiante"
                ...
                {resource.type && (
                  <div className="flex items-start space-x-2 min-w-0">
                    ...
                    <span className="text-xs xs:text-sm text-gray-600 break-words-safe min-w-0 leading-tight">
                      {resource.type}
                    </span>
                  </div>
                )}
                ...
                {resource.features && (
                  <div className="overflow-hidden">
                    <span className="text-xs font-semibold text-cola-red mb-2 block">
                      Características:
                    </span>
        ...
        <div className="mt-12 xs:mt-16 card-cola bg-gradient-to-r from-cola-red to-cola-dark-red text-white">
          <div className="text-center">
            <h3 className="font-coca-cola text-xl xs:text-2xl mb-4 xs:mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 xs:gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold mb-2 text-sm xs:text-base">
                  Apps Móviles
                </h4>
