    ...
    <footer className="gradient-cola text-white">
      <div className="section-container py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="bg-white text-cola-red w-10 h-10 rounded-full flex items-center justify-center hover:bg-red-50 transition-colors duration-300"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-coca-cola text-lg mb-4">NAVEGACIÓN RÁPIDA</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-coca-cola text-lg mb-4">INFORMACIÓN ACADÉMICA</h4>
            <div className="space-y-3">
              <div>
                <p className="text-red-100 text-sm">Autor:</p>
                <p className="text-white font-semibold">Aiker Ary Acosta Cantillo</p>
              </div>
              <div>
                <p className="text-red-100 text-sm">Área:</p>
                <p className="text-white font-semibold">Ingeniería de Sistemas</p>
              </div>
              <div>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-white font-semibold hover:text-red-100 transition-colors duration-300"
                >
              ...
              <div>
                ...
                <p className="text-white font-semibold">Mayo {currentYear}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Divider */}
        <div className="border-t border-red-400 my-8"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button
              onClick={scrollToTop}
              className="bg-white text-cola-red w-10 h-10 rounded-full flex items-center justify-center hover:bg-red-50 transition-all duration-300 transform hover:scale-110"
      ...
      <div className="relative">
        <svg className="w-full h-8" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" className="fill-cola-light-gray"></path>
        </svg>
      </div>
    </footer>
  )
