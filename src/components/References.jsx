...
const References = () => {
  const references = [
    {
      ...
      isbn: "978-1593279509",
      description:
        "Una introducción completa y moderna a JavaScript que cubre desde los fundamentos hasta conceptos avanzados.",
    },
    {
      id: 2,
      ...
      description:
        "Documentación oficial y completa de JavaScript mantenida por Mozilla.",
    },
    {
      id: 3,
      type: "Artículo Académico",
      title:
        "Teaching JavaScript: A Modern Approach to Web Development Education",
      ...
      description:
        "Investigación sobre metodologías efectivas para la enseñanza de JavaScript en entornos académicos.",
    },
    {
      id: 4,
      type: "Libro",
      ...
      isbn: "978-1492091509",
      description:
        "Serie de libros que profundiza en los aspectos fundamentales y avanzados de JavaScript.",
    },
    {
      id: 5,
      type: "Estándar Web",
      ...
      description:
        "Especificación oficial del lenguaje JavaScript (ECMAScript).",
    },
    {
      id: 6,
      type: "Artículo Web",
      ...
      description:
        "Tutorial comprensivo y actualizado sobre JavaScript moderno con ejemplos prácticos.",
    },
    {
      id: 7,
      type: "Libro",
      ...
      isbn: "978-1491952023",
      description:
        "Guía definitiva y exhaustiva de JavaScript para desarrolladores de todos los niveles.",
    },
    {
      id: 8,
      type: "Curso Online",
      ...
      description:
        "Curso completo en línea que cubre JavaScript desde principiante hasta avanzado.",
    },
  ];
  const formatReference = (ref) => {
    switch (ref.type) {
      case "Libro":
        ...
        }. ${ref.publisher}.${ref.isbn ? ` ISBN: ${ref.isbn}` : ""}`;
      case "Artículo Académico":
        return `${ref.author} (${ref.year}). ${ref.title}. ${ref.journal}, ${
          ref.volume
        }, ${ref.pages}.${ref.doi ? ` DOI: ${ref.doi}` : ""}`;
  ...
  return (
    <section
      id="referencias"
      className="py-20 bg-cola-light-gray overflow-hidden"
    >
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto break-words">
            Fuentes académicas y profesionales que respaldan el contenido de
            esta unidad didáctica, siguiendo estándares de citación académica.
          </p>
        </div>
              ...
              <div className="flex items-start space-x-3 xs:space-x-4 min-w-0 overflow-hidden">
                ...
                <div className="flex-grow min-w-0 overflow-hidden">
                  <div className="flex items-center gap-2 xs:gap-3 mb-3 min-w-0 flex-wrap">
                    {React.createElement(getTypeIcon(ref.type), {
                      className:
                        "w-5 h-5 xs:w-6 xs:h-6 text-cola-red flex-shrink-0",
                    })}
                    <span
                      className={`px-2 xs:px-3 py-1 rounded-full text-xs xs:text-sm font-semibold ${getTypeColor(
                        ref.type
                      )} flex-shrink-0 break-words max-w-full`}
                    >
                      {ref.type}
                    </span>
                    {ref.url && (
        ...
        <div className="mt-12 xs:mt-16 card-cola-safe bg-gradient-to-r from-cola-red to-cola-dark-red text-white overflow-hidden">
          <div className="text-center mb-6 xs:mb-8 overflow-hidden">
            <h3 className="font-coca-cola text-xl xs:text-2xl mb-3 xs:mb-4 break-words">
              NORMAS DE CITACIÓN
            </h3>
            <p className="text-red-100 leading-relaxed text-sm xs:text-base break-words overflow-wrap-anywhere">
              Todas las referencias siguen el formato APA (American
              Psychological Association) 7ª edición, asegurando consistencia y
              rigor académico.
            </p>
          </div>
          <div className="grid gap-4 xs:gap-6 md:grid-cols-3 overflow-hidden">
            <div className="text-center overflow-hidden">
              ...
              <h4 className="font-semibold mb-1 xs:mb-2 text-sm xs:text-base break-words">
                Verificación
              </h4>
              <p className="text-red-100 text-xs xs:text-sm leading-relaxed break-words overflow-wrap-anywhere">
                Todas las fuentes han sido verificadas y son de acceso público o
                académico.
              </p>
            </div>
            <div className="text-center overflow-hidden">
              ...
              <p className="text-red-100 text-xs xs:text-sm leading-relaxed break-words overflow-wrap-anywhere">
                Las referencias se revisan semestralmente para mantener
            ...
            <div className="text-center overflow-hidden">
              ...
              <p className="text-red-100 text-xs xs:text-sm leading-relaxed break-words overflow-wrap-anywhere">
                Cada referencia está directamente relacionada con los objetivos
                de aprendizaje.
              </p>
            </div>
          </div>
        ...
        <div className="mt-6 xs:mt-8 text-center overflow-hidden">
          <p className="text-gray-600 text-xs xs:text-sm break-words overflow-wrap-anywhere">
            <strong>Nota:</strong> Para acceder a recursos académicos con
            restricciones, consulte con la biblioteca de su institución
            educativa.
          </p>
        </div>
      </div>
