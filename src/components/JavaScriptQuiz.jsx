...
const JavaScriptQuiz = ({ quiz, onQuizComplete, onBackToSelection }) => {
  ...
  const handleAnswerSelect = (questionIndex, answerIndex) => {
    // Prevenir cambiar respuesta una vez seleccionada
    ...
    // Verificar si la respuesta es correcta inmediatamente
    ...
    setTimeout(() => {
      if (questionIndex < quiz.questions.length - 1) {
        ...
        setShowResults(true)
        if (onQuizComplete) {
          const finalCorrectCount = answerIndex === question.correctAnswer ? 
            correctAnswersCount + 1 : correctAnswersCount
    ...
    return (
      <div className="card-cola text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
          ...
          {/* Botella de progreso en el lado derecho */}
          <div className="lg:col-span-1 flex justify-center lg:justify-end">
            <div className="w-20 min-h-[220px] flex-shrink-0">
              <ColaBottleProgress score={0} maxScore={quiz.questions.length} animated={false} label="Progreso en Tiempo Real" />
            </div>
          </div>
        </div>
      </div>
  ...
  if (showResults) {
    const { message, color } = getScoreMessage(correctAnswersCount, quiz.questions.length)
    ...
    return (
      <div className="card-cola">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
            ...
            <div className="mb-8">
              ...
              <div className="bg-cola-light-gray rounded-lg p-6">
                <p className="text-gray-700 text-lg">
                  <strong>Resumen:</strong> Respondiste correctamente {correctAnswersCount} de {quiz.questions.length} preguntas
          ...
          {/* Botella de progreso final en el lado derecho */}
          <div className="lg:col-span-1 flex justify-center lg:justify-end">
            <div className="w-20 min-h-[220px] flex-shrink-0">
              <ColaBottleProgress 
