  ...
  const activities = [
    {
      ...
      difficulty: "Básico",
      description:
        "Actividad práctica donde los estudiantes experimentan con diferentes tipos de variables en JavaScript.",
      objectives: [
    ...
    },
    {
      ...
      description:
        "Desarrollo en equipos de una calculadora web funcional aplicando conceptos de DOM y eventos.",
      objectives: [
      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            Experiencias de aprendizaje diseñadas para aplicar conocimientos
            teóricos en contextos prácticos y colaborativos.
          </p>
        </div>
        <div className="space-y-8 min-w-0">
          {activities.map((activity) => (
            <div
              key={activity.id}
              className="card-cola min-w-0 max-w-full overflow-hidden"
            >
              <div
                      ...
                      <ul className="space-y-2 min-w-0">
                        {activity.objectives.map((objective, index) => (
                          ...
                          >
                            ...
                            <span className="text-gray-600 break-words overflow-wrap-anywhere min-w-0">
                              {objective}
                            </span>
                          </li>
                        ))}
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {activity.steps.map((step, index) => (
                        <div
                          key={index}
                          className="flex items-center space-x-3 p-3 bg-cola-light-gray rounded-lg"
                        >
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div className="card-cola text-center">
            ...
            <p className="text-gray-600">
              Sistema de puntos y logros que motiva el progreso continuo y la
              superación personal.
            </p>
          </div>
          <div className="card-cola text-center">
            ...
            <p className="text-gray-600">
              Trabajo en equipo y peer programming para fortalecer habilidades
              sociales y técnicas.
            </p>
          </div>
          <div className="card-cola text-center">
            ...
            <p className="text-gray-600">
              Evaluación constante y retroalimentación inmediata para acelerar
              el aprendizaje.
            </p>
          </div>
        </div>
