          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 xs:gap-6 md:gap-8">
            <div className="space-y-4 xs:space-y-6">
              <div className="card-cola">
                ...
                <p className="text-gray-600 leading-relaxed mb-4 xs:mb-6 text-sm xs:text-base">
                  Estudiante de Ingeniería de Sistemas apasionado por el
                  desarrollo web y la programación. Mi enfoque se centra en
                  crear soluciones tecnológicas innovadoras y en compartir
                  conocimiento a través de metodologías educativas efectivas.
                </p>
                <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-1 gap-2 xs:gap-3 mb-4 xs:mb-6">
                  <div className="text-center p-3 xs:p-4 bg-gradient-to-r from-cola-red to-cola-dark-red text-white rounded-lg">
                    ...
                    <div className="text-red-100 text-xs xs:text-sm">
                      Años programando
                    </div>
                  </div>
                  <div className="text-center p-3 xs:p-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg">
                    ...
                    <div className="text-blue-100 text-xs xs:text-sm">
                      Proyectos
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-4 xs:space-y-6">
              ...
              <div className="card-cola">
                ...
                <div className="bg-gradient-to-r from-cola-red to-cola-dark-red text-white p-4 xs:p-6 rounded-lg">
                  <h5 className="font-bold text-base xs:text-lg mb-2">
                    Ingeniería de Sistemas
                  </h5>
                  <p className="text-red-100 text-sm xs:text-base leading-relaxed">
                    Especialización en desarrollo de software, arquitectura de
                    sistemas y tecnologías web modernas.
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-4 xs:space-y-6">
              <div className="card-cola bg-gradient-to-br from-cola-red to-cola-dark-red text-white">
                <h4 className="font-coca-cola text-lg xs:text-xl mb-3 xs:mb-4">
                  FILOSOFÍA EDUCATIVA
                </h4>
                <p className="text-red-100 leading-relaxed mb-4 xs:mb-6 text-sm xs:text-base">
                  "Creo en el aprendizaje práctico y colaborativo. El
                  conocimiento se consolida mejor cuando se comparte y se aplica
                  en proyectos reales que resuelven problemas del mundo actual."
                </p>
                <div className="border-t border-red-300 pt-3 xs:pt-4">
                  <h5 className="font-bold text-red-100 mb-2 text-sm xs:text-base">
              ...
              <div className="card-cola">
                ...
                <div className="space-y-2 xs:space-y-3">
                  <div className="flex items-center space-x-2 xs:space-x-3">
                    <svg
                      className="w-4 h-4 xs:w-5 xs:h-5 text-cola-red flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                      <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                    </svg>
                    <span className="text-gray-600 text-xs xs:text-sm break-all">
                      aikera@uninorte.edu.co
                    </span>
                  </div>
                  <div className="flex items-center space-x-2 xs:space-x-3">
                    <svg
