    ...
    formative: [
      {
        ...
        description:
          "Evaluaciones cortas al final de cada módulo para verificar la comprensión de conceptos básicos.",
        criteria: [
      ...
      },
      {
        ...
        description:
          "Revisión colaborativa de código entre estudiantes para fomentar el aprendizaje mutuo.",
        criteria: [
    ...
    summative: [
      {
        ...
        description:
          "Desarrollo de una aplicación web full-stack utilizando JavaScript, HTML, CSS y un framework moderno.",
        criteria: [
      ...
      },
      {
        ...
        description:
          "Evaluación individual donde se resuelven problemas de programación en tiempo real.",
        criteria: [
      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            Sistema integral de evaluación que combina metodologías formativas y
            sumativas para garantizar un aprendizaje continuo y efectivo.
          </p>
        </div>
            ...
            {evaluationActivities[activeTab].map((activity, index) => (
              <div key={index} className="card-cola">
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold text-cola-dark-gray">
        ...
        {activeTab === "interactive" && <QuizSection />}
          ...
          <div className="card-cola bg-gradient-to-br from-cola-red to-cola-dark-red text-white">
            ...
            <div className="grid md:grid-cols-5 gap-4 mb-8">
              <div className="text-center">
                ...
                <p className="text-sm text-red-100">
                  Supera expectativas. Código profesional, innovador y
                  optimizado.
                </p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <div className="bg-white text-cola-red rounded-lg p-4 mb-2">
                  ...
                  <div className="text-sm">
                    {rubrics.project.needsImprovement}
                  </div>
                </div>
                <p className="text-sm text-red-100">
            ...
            <div className="text-center">
              <p className="text-red-100">
                La evaluación se basa en competencias técnicas, creatividad,
                presentación y capacidad de resolver problemas de manera
                autónoma.
              </p>
            </div>
          </div>
